...
/**
 * Bootstrap class for Marabahaya application.
 * <p>
 *     This to launch Marabahaya application to workaround
 ...
 * @since 1.0.0
 */
public class MarabahayaLauncher {
    ...
    public static void main(final String[] args) {
        LOG.log(Level.INFO, "Launch Marabahaya application.");
        LOG.log(
            Level.FINER,
        ...
        Marabahaya.main(args);
        LOG.log(Level.INFO, "Shutting down Marabahaya application.");
    }
